...
def generate_private_key(length=2048):
    """Generate an RSA key pair and return the private key"""
    try:
...
def generate_public_key(private_key_str):
...
def generate_secret(private_key, public_key):
    """This function is kept for compatibility but not used in RSA encryption"""
    pass